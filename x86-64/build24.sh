...
PACKAGES="$PACKAGES dnsmasq-dhcpv6"
PACKAGES="$PACKAGES dnsmasq-full"
PACKAGES="$PACKAGES dnsmasq_full_dhcp"
PACKAGES="$PACKAGES dnsmasq_full_dhcpv6"
PACKAGES="$PACKAGES dnsmasq_full_dnssec"
PACKAGES="$PACKAGES dnsmasq_full_auth"
PACKAGES="$PACKAGES dnsmasq_full_nftset"
PACKAGES="$PACKAGES dnsmasq_full_conntrack"
PACKAGES="$PACKAGES dnsmasq_full_noid"
PACKAGES="$PACKAGES dnsmasq_full_tftp"
...
PACKAGES="$PACKAGES luci-app-email"
...
PACKAGES="$PACKAGES luci-app-passwall_INCLUDE_SingBox"
PACKAGES="$PACKAGES luci-app-passwall_INCLUDE_V2ray_Geoview"
...
PACKAGES="$PACKAGES luci-app-rclone_INCLUDE_rclone-webui"
PACKAGES="$PACKAGES luci-app-rclone_INCLUDE_rclone-ng"
